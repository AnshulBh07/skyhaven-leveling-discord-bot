...
interface ICommunitySupportConfig {
	mentionRoles: string[];
	managerRoles: string[];
...
export interface IConfig {
	...
	communitySupportConfig: ICommunitySupportConfig;
	moodConfig: IMoodConfig;
	bannedUsers: UserBan[];
	kickedUsers: UserKick[];
...
export interface ICommandQueryInput extends CommandEntry {
	mood: string;
	userQuery: string;
}

export interface ToramKnowledgeEntry {
	name: string;
	aliases: string[];
	keywords: string[];
	category: string;
...
export interface ICommunitySupport {
	serverID: string;
	hostID: string;
	recipientID: string;
	messageID: string;
