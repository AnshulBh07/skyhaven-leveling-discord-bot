...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            ...
            data: {
                name: "rewarded",
                description: "Gives list of all rewarded guild quests. If user is specified gives details for the user only",
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    if (targetUser) {
                        ...
                        title = `📃 List of Rewarded Guild Quests for ${targetUser ? targetUser.username : ""}`;
                    }
                    //   create embed with buttons
                    yield (0, gquestUtils_1.generateGquestsListEmbed)(client, interaction, gquests, title, targetUser ? targetUser.id : "", "rewarded", "gquest");
                }
                catch (err) {
