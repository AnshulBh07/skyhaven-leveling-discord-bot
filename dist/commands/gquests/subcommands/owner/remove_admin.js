...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            ...
            data: {
                name: "remove-admin",
                description: "Removes a role that can manage member's guild quest submissions.",
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    config.gquestMazeConfig.managerRoles =
                        config.gquestMazeConfig.managerRoles.filter((managerRole) => managerRole !== role.id);
                    yield config.save();
                    yield interaction.editReply({
