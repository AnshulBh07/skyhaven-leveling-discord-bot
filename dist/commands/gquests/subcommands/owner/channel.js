...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            ...
            data: {
                name: "channel",
                description: "Channel where guild members submit guild quests and all related notfications are sent",
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    yield interaction.editReply({
                        content: `✅ The guild quest channel has been successfully set to <#${channel.id}>.`,
                    });
                }
                catch (err) {
