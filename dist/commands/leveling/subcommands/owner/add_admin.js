...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            ...
            data: {
                name: "add-admin",
                description: "Adds a role that can manage leveling system",
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    config.levelConfig.managerRoles.push(role.id);
                    yield config.save();
                    yield interaction.editReply({
                        content: `✅ Added <@&${role.id}> as a management role for leveling system.`,
                    });
                }
                catch (err) {
                    console.error("Error in lvl add-admin callback : ", err);
                }
            }),
        };
    }
    catch (err) {
        console.error("Error in lvl add-admin subcommand : ", err);
        return undefined;
    }
});
