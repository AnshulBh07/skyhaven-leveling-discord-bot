            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    if (ignoredChannels.includes(ans_channel.id)) {
                        yield interaction.editReply("🚫 This channel is already in the ignore list.");
                        return;
                    }
                    ...
                    yield interaction.editReply(`Added <#${ans_channel.id}> to ignore list.`);
                }
                catch (err) {
                    console.error("Error in lvl ignore-channel subcommand callback : ", err);
                }
            }),
        };
    }
