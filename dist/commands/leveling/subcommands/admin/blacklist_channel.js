            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    if (blacklistedChannels.includes(ans_channel.id)) {
                        yield interaction.editReply("Channel is already blacklisted.");
                        return;
                    }
                    ...
                    yield interaction.editReply(`Added <#${ans_channel.id}> to blacklist.`);
                }
                catch (err) {
                    console.error("Error in lvl blacklist-channel subcommand callback : ", err);
                }
            }),
        };
    }
