        ...
        return {
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    if (!isBanned) {
                        yield interaction.editReply(`<@${targetUser.id}> is not present in guild raids ban list.`);
                        return;
                    }
                    yield configSchema_1.default.findOneAndUpdate({ serverID: guildID }, { $pull: { "raidConfig.banList": { userID: targetUser.id } } });
                    yield interaction.editReply(`<@${targetUser.id}> has been removed from ban list.`);
                }
                catch (err) {
