        ...
        return {
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (isBanned) {
                        yield interaction.editReply(`<@${targetUser.id}> is already banned from guild raids.`);
                        return;
                    }
                    ...
                    yield interaction.editReply(`<@${targetUser.id}> has been banned from participating in any further guild raids. Use \`/raid unban\` to remove user from banlist whenever you want.`);
                }
                catch (err) {
