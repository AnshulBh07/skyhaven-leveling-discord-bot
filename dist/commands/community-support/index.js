...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return {
            ...
            permissionsRequired: [],
            callback: (client, interaction, mood) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    if (adminCommands.includes(subcommandName) && !isAdmin) {
                        if (!(yield (0, permissionsCheck_1.isManager)(client, interaction.user.id, guild.id, "cs"))) {
                            yield interaction.editReply({
                                content: "⚠️ You lack the required permissions to use this command.",
                            });
                            return;
                    ...
                    if (userCommands.includes(subcommandName) && !isAdmin) {
                        if (!(yield (0, permissionsCheck_1.isUser)(client, interaction.user.id, guild.id, "cs"))) {
                            yield interaction.editReply({
                                content: "⚠️ You lack the required permissions to use this command.",
                            });
                            return;
                    ...
                    console.error("Error in community-support root command callabck : ", err);
                }
            }),
        };
    }
