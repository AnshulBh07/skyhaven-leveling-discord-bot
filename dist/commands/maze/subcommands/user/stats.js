        ...
        return {
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const mazeStatusEmbed = new discord_js_1.EmbedBuilder()
                        ...
                        name: "\u200b",
                        value: `**📈 Contribution Score : **${(0, gquestUtils_1.getContributionScore)(user.mazes.rewarded.length, user.mazes.rejected.length)}`,
                        inline: false,
                    }, {
                        name: "\u200b",
                        value: `**⏳ Last Submission : **${user.mazes.lastSubmissionDate
                            ? `<t:${Math.floor(user.mazes.lastSubmissionDate.getTime() / 1000)}:F>`
                            : "None"}`,
                        inline: false,
                    }, {
                        name: "\u200b",
                        ...
                        name: "\u200b",
                        value: `**📬 DM Notifications : **${user.mazes.dmNotif ? "🟢 Enabled" : "🔴 Disabled"}`,
                        inline: false,
                    })
                        .setFooter({
