...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            ...
            data: {
                name: "rejected",
                description: "Gives list of all rejected guild mazes. If user is specified gives details for the user only",
            ...
            callback: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    yield (0, gquestUtils_1.generateGquestsListEmbed)(client, interaction, mazes, title, targetUser ? targetUser.id : "", "rejected", "maze");
                }
                catch (err) {
