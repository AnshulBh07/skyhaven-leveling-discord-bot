...
exports.drawRoundedHexagonWithLevel = drawRoundedHexagonWithLevel;
const canvas_1 = require("canvas");
function drawRoundedHexagonWithLevel(x, y, size, cornerRadius, color, text, canvasWidth = 800, canvasHeight = 180) {
    const canvas = (0, canvas_1.createCanvas)(canvasWidth, canvasHeight);
    const ctx = canvas.getContext("2d");
    const angleStep = (Math.PI * 2) / 6;
    function drawHexPath(r) {
        const points = [];
        for (let i = 0; i < 6; i++) {
